...
export default class MTProto {
  ...
  call(method: 'account.registerDevice', params: { no_muted: boolean = true, token_type: number, token: string, app_sandbox: boolean, secret: UInt8Array, other_uids: number[] }): Promise<boolean>;
  ...
  call(method: 'messages.getDialogs', params: { exclude_pinned: boolean = true, folder_id: number, offset_date: number, offset_id: number, offset_peer: InputPeer, limit: number, hash: number }): Promise<messages_Dialogs>;
  ...
  call(method: 'messages.deleteHistory', params: { just_clear: boolean = true, revoke: boolean = true, peer: InputPeer, max_id: number, min_date: number, max_date: number }): Promise<messages_AffectedHistory>;
  call(method: 'messages.deleteMessages', params: { revoke: boolean = true, id: number[] }): Promise<messages_AffectedMessages>;
  ...
  call(method: 'messages.sendMessage', params: { no_webpage: boolean = true, silent: boolean = true, background: boolean = true, clear_draft: boolean = true, noforwards: boolean = true, peer: InputPeer, reply_to_msg_id: number, message: string, random_id: number, reply_markup: ReplyMarkup, entities: MessageEntity[], schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  call(method: 'messages.sendMedia', params: { silent: boolean = true, background: boolean = true, clear_draft: boolean = true, noforwards: boolean = true, peer: InputPeer, reply_to_msg_id: number, media: InputMedia, message: string, random_id: number, reply_markup: ReplyMarkup, entities: MessageEntity[], schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  call(method: 'messages.forwardMessages', params: { silent: boolean = true, background: boolean = true, with_my_score: boolean = true, drop_author: boolean = true, drop_media_captions: boolean = true, noforwards: boolean = true, from_peer: InputPeer, id: number[], random_id: number[], to_peer: InputPeer, schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  ...
  call(method: 'messages.deleteChatUser', params: { revoke_history: boolean = true, chat_id: number, user_id: InputUser }): Promise<Updates>;
  ...
  call(method: 'upload.getFile', params: { precise: boolean = true, cdn_supported: boolean = true, location: InputFileLocation, offset: number, limit: number }): Promise<upload_File>;
  ...
  call(method: 'messages.discardEncryption', params: { delete_history: boolean = true, chat_id: number }): Promise<boolean>;
  ...
  call(method: 'messages.sendEncrypted', params: { silent: boolean = true, peer: InputEncryptedChat, random_id: number, data: UInt8Array }): Promise<messages_SentEncryptedMessage>;
  call(method: 'messages.sendEncryptedFile', params: { silent: boolean = true, peer: InputEncryptedChat, random_id: number, data: UInt8Array, file: InputEncryptedFile }): Promise<messages_SentEncryptedMessage>;
  ...
  call(method: 'initConnection', params: { api_id: number, device_model: string, system_version: string, app_version: string, system_lang_code: string, lang_pack: string, lang_code: string, proxy: InputClientProxy, params: JSONValue, query: !X }): Promise<X>;
  ...
  call(method: 'messages.exportChatInvite', params: { legacy_revoke_permanent: boolean = true, request_needed: boolean = true, peer: InputPeer, expire_date: number, usage_limit: number, title: string }): Promise<ExportedChatInvite>;
  ...
  call(method: 'channels.createChannel', params: { broadcast: boolean = true, megagroup: boolean = true, for_import: boolean = true, title: string, about: string, geo_point: InputGeoPoint, address: string }): Promise<Updates>;
  ...
  call(method: 'updates.getChannelDifference', params: { force: boolean = true, channel: InputChannel, filter: ChannelMessagesFilter, pts: number, limit: number }): Promise<updates_ChannelDifference>;
  ...
  call(method: 'messages.reorderStickerSets', params: { masks: boolean = true, emojis: boolean = true, order: number[] }): Promise<boolean>;
  ...
  call(method: 'messages.setInlineBotResults', params: { gallery: boolean = true, private: boolean = true, query_id: number, results: InputBotInlineResult[], cache_time: number, next_offset: string, switch_pm: InlineBotSwitchPM }): Promise<boolean>;
  call(method: 'messages.sendInlineBotResult', params: { silent: boolean = true, background: boolean = true, clear_draft: boolean = true, hide_via: boolean = true, peer: InputPeer, reply_to_msg_id: number, random_id: number, query_id: number, id: string, schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  call(method: 'channels.exportMessageLink', params: { grouped: boolean = true, thread: boolean = true, channel: InputChannel, id: number }): Promise<ExportedMessageLink>;
  ...
  call(method: 'messages.editMessage', params: { no_webpage: boolean = true, peer: InputPeer, id: number, message: string, media: InputMedia, reply_markup: ReplyMarkup, entities: MessageEntity[], schedule_date: number }): Promise<Updates>;
  call(method: 'messages.editInlineBotMessage', params: { no_webpage: boolean = true, id: InputBotInlineMessageID, message: string, media: InputMedia, reply_markup: ReplyMarkup, entities: MessageEntity[] }): Promise<boolean>;
  call(method: 'messages.getBotCallbackAnswer', params: { game: boolean = true, peer: InputPeer, msg_id: number, data: UInt8Array, password: InputCheckPasswordSRP }): Promise<messages_BotCallbackAnswer>;
  call(method: 'messages.setBotCallbackAnswer', params: { alert: boolean = true, query_id: number, message: string, url: string, cache_time: number }): Promise<boolean>;
  call(method: 'contacts.getTopPeers', params: { correspondents: boolean = true, bots_pm: boolean = true, bots_inline: boolean = true, phone_calls: boolean = true, forward_users: boolean = true, forward_chats: boolean = true, groups: boolean = true, channels: boolean = true, offset: number, limit: number, hash: number }): Promise<contacts_TopPeers>;
  ...
  call(method: 'messages.saveDraft', params: { no_webpage: boolean = true, reply_to_msg_id: number, peer: InputPeer, message: string, entities: MessageEntity[] }): Promise<boolean>;
  ...
  call(method: 'messages.getRecentStickers', params: { attached: boolean = true, hash: number }): Promise<messages_RecentStickers>;
  call(method: 'messages.saveRecentSticker', params: { attached: boolean = true, id: InputDocument, unsave: boolean }): Promise<boolean>;
  call(method: 'messages.clearRecentStickers', params: { attached: boolean = true }): Promise<boolean>;
  call(method: 'messages.getArchivedStickers', params: { masks: boolean = true, emojis: boolean = true, offset_id: number, limit: number }): Promise<messages_ArchivedStickers>;
  ...
  call(method: 'channels.getAdminedPublicChannels', params: { by_location: boolean = true, check_limit: boolean = true }): Promise<messages_Chats>;
  ...
  call(method: 'messages.setGameScore', params: { edit_message: boolean = true, force: boolean = true, peer: InputPeer, id: number, user_id: InputUser, score: number }): Promise<Updates>;
  call(method: 'messages.setInlineGameScore', params: { edit_message: boolean = true, force: boolean = true, id: InputBotInlineMessageID, user_id: InputUser, score: number }): Promise<boolean>;
  ...
  call(method: 'messages.toggleDialogPin', params: { pinned: boolean = true, peer: InputDialogPeer }): Promise<boolean>;
  call(method: 'messages.reorderPinnedDialogs', params: { force: boolean = true, folder_id: number, order: InputDialogPeer[] }): Promise<boolean>;
  ...
  call(method: 'payments.validateRequestedInfo', params: { save: boolean = true, peer: InputPeer, msg_id: number, info: PaymentRequestedInfo }): Promise<payments_ValidatedRequestedInfo>;
  ...
  call(method: 'payments.clearSavedInfo', params: { credentials: boolean = true, info: boolean = true }): Promise<boolean>;
  ...
  call(method: 'messages.setBotPrecheckoutResults', params: { success: boolean = true, query_id: number, error: string }): Promise<boolean>;
  call(method: 'stickers.createStickerSet', params: { masks: boolean = true, animated: boolean = true, videos: boolean = true, user_id: InputUser, title: string, short_name: string, thumb: InputDocument, stickers: InputStickerSetItem[], software: string }): Promise<messages_StickerSet>;
  ...
  call(method: 'phone.requestCall', params: { video: boolean = true, user_id: InputUser, random_id: number, g_a_hash: UInt8Array, protocol: PhoneCallProtocol }): Promise<phone_PhoneCall>;
  ...
  call(method: 'phone.discardCall', params: { video: boolean = true, peer: InputPhoneCall, duration: number, reason: PhoneCallDiscardReason, connection_id: number }): Promise<Updates>;
  call(method: 'phone.setCallRating', params: { user_initiative: boolean = true, peer: InputPhoneCall, rating: number, comment: string }): Promise<Updates>;
  ...
  call(method: 'messages.sendMultiMedia', params: { silent: boolean = true, background: boolean = true, clear_draft: boolean = true, noforwards: boolean = true, peer: InputPeer, reply_to_msg_id: number, multi_media: InputSingleMedia[], schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  ...
  call(method: 'messages.searchStickerSets', params: { exclude_featured: boolean = true, q: string, hash: number }): Promise<messages_FoundStickerSets>;
  ...
  call(method: 'account.initTakeoutSession', params: { contacts: boolean = true, message_users: boolean = true, message_chats: boolean = true, message_megagroups: boolean = true, message_channels: boolean = true, files: boolean = true, file_max_size: number }): Promise<account_Takeout>;
  call(method: 'account.finishTakeoutSession', params: { success: boolean = true }): Promise<boolean>;
  ...
  call(method: 'messages.markDialogUnread', params: { unread: boolean = true, peer: InputDialogPeer }): Promise<boolean>;
  ...
  call(method: 'messages.updatePinnedMessage', params: { silent: boolean = true, unpin: boolean = true, pm_oneside: boolean = true, peer: InputPeer, id: number }): Promise<Updates>;
  ...
  call(method: 'account.getNotifyExceptions', params: { compare_sound: boolean = true, peer: InputNotifyPeer }): Promise<Updates>;
  ...
  call(method: 'account.saveAutoDownloadSettings', params: { low: boolean = true, high: boolean = true, settings: AutoDownloadSettings }): Promise<boolean>;
  ...
  call(method: 'messages.acceptUrlAuth', params: { write_allowed: boolean = true, peer: InputPeer, msg_id: number, button_id: number, url: string }): Promise<UrlAuthResult>;
  call(method: 'messages.hidePeerSettingsBar', params: { peer: InputPeer }): Promise<boolean>;
  call(method: 'contacts.addContact', params: { add_phone_privacy_exception: boolean = true, id: InputUser, first_name: string, last_name: string, phone: string }): Promise<Updates>;
  ...
  call(method: 'contacts.getLocated', params: { background: boolean = true, geo_point: InputGeoPoint, self_expires: number }): Promise<Updates>;
  ...
  call(method: 'account.installTheme', params: { dark: boolean = true, theme: InputTheme, format: string, base_theme: BaseTheme }): Promise<boolean>;
  ...
  call(method: 'account.setContentSettings', params: { sensitive_enabled: boolean = true }): Promise<boolean>;
  ...
  call(method: 'messages.toggleStickerSets', params: { uninstall: boolean = true, archive: boolean = true, unarchive: boolean = true, stickersets: InputStickerSet[] }): Promise<boolean>;
  ...
  call(method: 'stats.getBroadcastStats', params: { dark: boolean = true, channel: InputChannel }): Promise<stats_BroadcastStats>;
  ...
  call(method: 'stats.getMegagroupStats', params: { dark: boolean = true, channel: InputChannel }): Promise<stats_MegagroupStats>;
  ...
  call(method: 'contacts.blockFromReplies', params: { delete_message: boolean = true, delete_history: boolean = true, report_spam: boolean = true, msg_id: number }): Promise<Updates>;
  ...
  call(method: 'stats.getMessageStats', params: { dark: boolean = true, channel: InputChannel, msg_id: number }): Promise<stats_MessageStats>;
  call(method: 'messages.unpinAllMessages', params: { peer: InputPeer }): Promise<messages_AffectedHistory>;
  call(method: 'phone.createGroupCall', params: { rtmp_stream: boolean = true, peer: InputPeer, random_id: number, title: string, schedule_date: number }): Promise<Updates>;
  call(method: 'phone.joinGroupCall', params: { muted: boolean = true, video_stopped: boolean = true, call: InputGroupCall, join_as: InputPeer, invite_hash: string, params: DataJSON }): Promise<Updates>;
  ...
  call(method: 'phone.toggleGroupCallSettings', params: { reset_invite_hash: boolean = true, call: InputGroupCall, join_muted: boolean }): Promise<Updates>;
  ...
  call(method: 'messages.deletePhoneCallHistory', params: { revoke: boolean = true }): Promise<messages_AffectedFoundMessages>;
  ...
  call(method: 'messages.getExportedChatInvites', params: { revoked: boolean = true, peer: InputPeer, admin_id: InputUser, offset_date: number, offset_link: string, limit: number }): Promise<messages_ExportedChatInvites>;
  call(method: 'messages.getExportedChatInvite', params: { peer: InputPeer, link: string }): Promise<messages_ExportedChatInvite>;
  call(method: 'messages.editExportedChatInvite', params: { revoked: boolean = true, peer: InputPeer, link: string, expire_date: number, usage_limit: number, request_needed: boolean, title: string }): Promise<messages_ExportedChatInvite>;
  ...
  call(method: 'messages.getChatInviteImporters', params: { requested: boolean = true, peer: InputPeer, link: string, q: string, offset_date: number, offset_user: InputUser, limit: number }): Promise<messages_ChatInviteImporters>;
  ...
  call(method: 'phone.toggleGroupCallRecord', params: { start: boolean = true, video: boolean = true, call: InputGroupCall, title: string, video_portrait: boolean }): Promise<Updates>;
  ...
  call(method: 'phone.exportGroupCallInvite', params: { can_self_unmute: boolean = true, call: InputGroupCall }): Promise<phone_ExportedGroupCallInvite>;
  ...
  call(method: 'messages.hideChatJoinRequest', params: { approved: boolean = true, peer: InputPeer, user_id: InputUser }): Promise<Updates>;
  call(method: 'messages.hideAllChatJoinRequests', params: { approved: boolean = true, peer: InputPeer, link: string }): Promise<Updates>;
  ...
  call(method: 'messages.sendReaction', params: { big: boolean = true, peer: InputPeer, msg_id: number, reaction: string }): Promise<Updates>;
