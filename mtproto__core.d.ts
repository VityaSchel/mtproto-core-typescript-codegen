...
export default class MTProto {
  ...
  call(method: 'messages.deleteHistory', params: { just_clear = true, revoke = true, peer: InputPeer, max_id: number, min_date: number, max_date: number }): Promise<messages_AffectedHistory>;
  call(method: 'messages.deleteMessages', params: { revoke = true, id: number[] }): Promise<messages_AffectedMessages>;
  ...
  call(method: 'messages.sendMessage', params: { no_webpage = true, silent = true, background = true, clear_draft = true, noforwards = true, peer: InputPeer, reply_to_msg_id: number, message: string, random_id: number, reply_markup: ReplyMarkup, entities: MessageEntity[], schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  call(method: 'messages.sendMedia', params: { silent = true, background = true, clear_draft = true, noforwards = true, peer: InputPeer, reply_to_msg_id: number, media: InputMedia, message: string, random_id: number, reply_markup: ReplyMarkup, entities: MessageEntity[], schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  call(method: 'messages.forwardMessages', params: { silent = true, background = true, with_my_score = true, drop_author = true, drop_media_captions = true, noforwards = true, from_peer: InputPeer, id: number[], random_id: number[], to_peer: InputPeer, schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  ...
  call(method: 'messages.deleteChatUser', params: { revoke_history = true, chat_id: number, user_id: InputUser }): Promise<Updates>;
  ...
  call(method: 'upload.getFile', params: { precise = true, cdn_supported = true, location: InputFileLocation, offset: number, limit: number }): Promise<upload_File>;
  ...
  call(method: 'messages.discardEncryption', params: { delete_history = true, chat_id: number }): Promise<boolean>;
  ...
  call(method: 'messages.sendEncrypted', params: { silent = true, peer: InputEncryptedChat, random_id: number, data: UInt8Array }): Promise<messages_SentEncryptedMessage>;
  call(method: 'messages.sendEncryptedFile', params: { silent = true, peer: InputEncryptedChat, random_id: number, data: UInt8Array, file: InputEncryptedFile }): Promise<messages_SentEncryptedMessage>;
  ...
  call(method: 'messages.exportChatInvite', params: { legacy_revoke_permanent = true, request_needed = true, peer: InputPeer, expire_date: number, usage_limit: number, title: string }): Promise<ExportedChatInvite>;
  ...
  call(method: 'channels.createChannel', params: { broadcast = true, megagroup = true, for_import = true, title: string, about: string, geo_point: InputGeoPoint, address: string }): Promise<Updates>;
  ...
  call(method: 'updates.getChannelDifference', params: { force = true, channel: InputChannel, filter: ChannelMessagesFilter, pts: number, limit: number }): Promise<updates_ChannelDifference>;
  ...
  call(method: 'messages.reorderStickerSets', params: { masks = true, emojis = true, order: number[] }): Promise<boolean>;
  ...
  call(method: 'messages.setInlineBotResults', params: { gallery = true, private = true, query_id: number, results: InputBotInlineResult[], cache_time: number, next_offset: string, switch_pm: InlineBotSwitchPM }): Promise<boolean>;
  call(method: 'messages.sendInlineBotResult', params: { silent = true, background = true, clear_draft = true, hide_via = true, peer: InputPeer, reply_to_msg_id: number, random_id: number, query_id: number, id: string, schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  call(method: 'channels.exportMessageLink', params: { grouped = true, thread = true, channel: InputChannel, id: number }): Promise<ExportedMessageLink>;
  ...
  call(method: 'messages.editMessage', params: { no_webpage = true, peer: InputPeer, id: number, message: string, media: InputMedia, reply_markup: ReplyMarkup, entities: MessageEntity[], schedule_date: number }): Promise<Updates>;
  call(method: 'messages.editInlineBotMessage', params: { no_webpage = true, id: InputBotInlineMessageID, message: string, media: InputMedia, reply_markup: ReplyMarkup, entities: MessageEntity[] }): Promise<boolean>;
  call(method: 'messages.getBotCallbackAnswer', params: { game = true, peer: InputPeer, msg_id: number, data: UInt8Array, password: InputCheckPasswordSRP }): Promise<messages_BotCallbackAnswer>;
  call(method: 'messages.setBotCallbackAnswer', params: { alert = true, query_id: number, message: string, url: string, cache_time: number }): Promise<boolean>;
  call(method: 'contacts.getTopPeers', params: { correspondents = true, bots_pm = true, bots_inline = true, phone_calls = true, forward_users = true, forward_chats = true, groups = true, channels = true, offset: number, limit: number, hash: number }): Promise<contacts_TopPeers>;
  ...
  call(method: 'messages.saveDraft', params: { no_webpage = true, reply_to_msg_id: number, peer: InputPeer, message: string, entities: MessageEntity[] }): Promise<boolean>;
  ...
  call(method: 'messages.getRecentStickers', params: { attached = true, hash: number }): Promise<messages_RecentStickers>;
  call(method: 'messages.saveRecentSticker', params: { attached = true, id: InputDocument, unsave: boolean }): Promise<boolean>;
  call(method: 'messages.clearRecentStickers', params: { attached = true }): Promise<boolean>;
  call(method: 'messages.getArchivedStickers', params: { masks = true, emojis = true, offset_id: number, limit: number }): Promise<messages_ArchivedStickers>;
  ...
  call(method: 'channels.getAdminedPublicChannels', params: { by_location = true, check_limit = true }): Promise<messages_Chats>;
  ...
  call(method: 'messages.setGameScore', params: { edit_message = true, force = true, peer: InputPeer, id: number, user_id: InputUser, score: number }): Promise<Updates>;
  call(method: 'messages.setInlineGameScore', params: { edit_message = true, force = true, id: InputBotInlineMessageID, user_id: InputUser, score: number }): Promise<boolean>;
  ...
  call(method: 'messages.toggleDialogPin', params: { pinned = true, peer: InputDialogPeer }): Promise<boolean>;
  call(method: 'messages.reorderPinnedDialogs', params: { force = true, folder_id: number, order: InputDialogPeer[] }): Promise<boolean>;
  ...
  call(method: 'payments.validateRequestedInfo', params: { save = true, peer: InputPeer, msg_id: number, info: PaymentRequestedInfo }): Promise<payments_ValidatedRequestedInfo>;
  ...
  call(method: 'payments.clearSavedInfo', params: { credentials = true, info = true }): Promise<boolean>;
  ...
  call(method: 'messages.setBotPrecheckoutResults', params: { success = true, query_id: number, error: string }): Promise<boolean>;
  call(method: 'stickers.createStickerSet', params: { masks = true, animated = true, videos = true, user_id: InputUser, title: string, short_name: string, thumb: InputDocument, stickers: InputStickerSetItem[], software: string }): Promise<messages_StickerSet>;
  ...
  call(method: 'phone.requestCall', params: { video = true, user_id: InputUser, random_id: number, g_a_hash: UInt8Array, protocol: PhoneCallProtocol }): Promise<phone_PhoneCall>;
  ...
  call(method: 'phone.discardCall', params: { video = true, peer: InputPhoneCall, duration: number, reason: PhoneCallDiscardReason, connection_id: number }): Promise<Updates>;
  call(method: 'phone.setCallRating', params: { user_initiative = true, peer: InputPhoneCall, rating: number, comment: string }): Promise<Updates>;
  ...
  call(method: 'messages.sendMultiMedia', params: { silent = true, background = true, clear_draft = true, noforwards = true, peer: InputPeer, reply_to_msg_id: number, multi_media: InputSingleMedia[], schedule_date: number, send_as: InputPeer }): Promise<Updates>;
  ...
  call(method: 'messages.searchStickerSets', params: { exclude_featured = true, q: string, hash: number }): Promise<messages_FoundStickerSets>;
  ...
  call(method: 'account.initTakeoutSession', params: { contacts = true, message_users = true, message_chats = true, message_megagroups = true, message_channels = true, files = true, file_max_size: number }): Promise<account_Takeout>;
  call(method: 'account.finishTakeoutSession', params: { success = true }): Promise<boolean>;
  ...
  call(method: 'messages.markDialogUnread', params: { unread = true, peer: InputDialogPeer }): Promise<boolean>;
  ...
  call(method: 'messages.updatePinnedMessage', params: { silent = true, unpin = true, pm_oneside = true, peer: InputPeer, id: number }): Promise<Updates>;
  ...
  call(method: 'account.getNotifyExceptions', params: { compare_sound = true, peer: InputNotifyPeer }): Promise<Updates>;
  ...
  call(method: 'account.saveAutoDownloadSettings', params: { low = true, high = true, settings: AutoDownloadSettings }): Promise<boolean>;
  ...
  call(method: 'messages.acceptUrlAuth', params: { write_allowed = true, peer: InputPeer, msg_id: number, button_id: number, url: string }): Promise<UrlAuthResult>;
  call(method: 'messages.hidePeerSettingsBar', params: { peer: InputPeer }): Promise<boolean>;
  call(method: 'contacts.addContact', params: { add_phone_privacy_exception = true, id: InputUser, first_name: string, last_name: string, phone: string }): Promise<Updates>;
  ...
  call(method: 'contacts.getLocated', params: { background = true, geo_point: InputGeoPoint, self_expires: number }): Promise<Updates>;
  ...
  call(method: 'account.installTheme', params: { dark = true, theme: InputTheme, format: string, base_theme: BaseTheme }): Promise<boolean>;
  ...
  call(method: 'account.setContentSettings', params: { sensitive_enabled = true }): Promise<boolean>;
  ...
  call(method: 'messages.toggleStickerSets', params: { uninstall = true, archive = true, unarchive = true, stickersets: InputStickerSet[] }): Promise<boolean>;
  ...
  call(method: 'stats.getBroadcastStats', params: { dark = true, channel: InputChannel }): Promise<stats_BroadcastStats>;
  ...
  call(method: 'stats.getMegagroupStats', params: { dark = true, channel: InputChannel }): Promise<stats_MegagroupStats>;
  ...
  call(method: 'contacts.blockFromReplies', params: { delete_message = true, delete_history = true, report_spam = true, msg_id: number }): Promise<Updates>;
  ...
  call(method: 'stats.getMessageStats', params: { dark = true, channel: InputChannel, msg_id: number }): Promise<stats_MessageStats>;
  call(method: 'messages.unpinAllMessages', params: { peer: InputPeer }): Promise<messages_AffectedHistory>;
  call(method: 'phone.createGroupCall', params: { rtmp_stream = true, peer: InputPeer, random_id: number, title: string, schedule_date: number }): Promise<Updates>;
  call(method: 'phone.joinGroupCall', params: { muted = true, video_stopped = true, call: InputGroupCall, join_as: InputPeer, invite_hash: string, params: DataJSON }): Promise<Updates>;
  ...
  call(method: 'phone.toggleGroupCallSettings', params: { reset_invite_hash = true, call: InputGroupCall, join_muted: boolean }): Promise<Updates>;
  ...
  call(method: 'messages.deletePhoneCallHistory', params: { revoke = true }): Promise<messages_AffectedFoundMessages>;
  ...
  call(method: 'messages.getExportedChatInvites', params: { revoked = true, peer: InputPeer, admin_id: InputUser, offset_date: number, offset_link: string, limit: number }): Promise<messages_ExportedChatInvites>;
  call(method: 'messages.getExportedChatInvite', params: { peer: InputPeer, link: string }): Promise<messages_ExportedChatInvite>;
  call(method: 'messages.editExportedChatInvite', params: { revoked = true, peer: InputPeer, link: string, expire_date: number, usage_limit: number, request_needed: boolean, title: string }): Promise<messages_ExportedChatInvite>;
  ...
  call(method: 'messages.getChatInviteImporters', params: { requested = true, peer: InputPeer, link: string, q: string, offset_date: number, offset_user: InputUser, limit: number }): Promise<messages_ChatInviteImporters>;
  ...
  call(method: 'phone.toggleGroupCallRecord', params: { start = true, video = true, call: InputGroupCall, title: string, video_portrait: boolean }): Promise<Updates>;
  ...
  call(method: 'phone.exportGroupCallInvite', params: { can_self_unmute = true, call: InputGroupCall }): Promise<phone_ExportedGroupCallInvite>;
  ...
  call(method: 'messages.hideChatJoinRequest', params: { approved = true, peer: InputPeer, user_id: InputUser }): Promise<Updates>;
  call(method: 'messages.hideAllChatJoinRequests', params: { approved = true, peer: InputPeer, link: string }): Promise<Updates>;
  ...
  call(method: 'messages.sendReaction', params: { big = true, peer: InputPeer, msg_id: number, reaction: string }): Promise<Updates>;
